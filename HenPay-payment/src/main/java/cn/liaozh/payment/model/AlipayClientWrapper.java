...
public class AlipayClientWrapper {
    ...
    public static AlipayClientWrapper buildAlipayClientWrapper(Byte useCert, Byte sandbox, String appId, String privateKey, String alipayPublicKey, String signType, String appCert,
        ...
        if(useCert != null && useCert == CS.YES){ //证书的方式
            ...
            certAlipayRequest.setServerUrl(sandbox == CS.YES ? cn.liaozh.core.model.params.alipay.AlipayConfig.SANDBOX_SERVER_URL : cn.liaozh.core.model.params.alipay.AlipayConfig.PROD_SERVER_URL);
            certAlipayRequest.setAppId(appId);
            certAlipayRequest.setPrivateKey(privateKey);
            certAlipayRequest.setFormat(cn.liaozh.core.model.params.alipay.AlipayConfig.FORMAT);
            certAlipayRequest.setCharset(cn.liaozh.core.model.params.alipay.AlipayConfig.CHARSET);
            ...
            alipayClient = new DefaultAlipayClient(sandbox == CS.YES ? cn.liaozh.core.model.params.alipay.AlipayConfig.SANDBOX_SERVER_URL : cn.liaozh.core.model.params.alipay.AlipayConfig.PROD_SERVER_URL
                    , appId, privateKey, cn.liaozh.core.model.params.alipay.AlipayConfig.FORMAT, AlipayConfig.CHARSET,
