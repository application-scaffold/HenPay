...
import cn.liaozh.service.impl.MchNotifyRecordService;
...
public class PayMchNotifyService {
    ...
    public String createNotifyUrl(PayOrder payOrder, String appSecret) {
        ...
        // 报文签名
        jsonObject.put("sign", HenPayKit.getSign(jsonObject, appSecret));
    ...
    public String createReturnUrl(PayOrder payOrder, String appSecret) {
        ...
        // 报文签名
        jsonObject.put("sign", HenPayKit.getSign(jsonObject, appSecret));   // 签名
