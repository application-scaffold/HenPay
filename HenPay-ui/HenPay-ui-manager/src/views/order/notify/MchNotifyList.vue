...
<!--              <a-icon slot="suffixIcon" type="sync" />-->
            ...
            <henpay-text-up :placeholder="'订单ID'" v-model:value="vdata.searchData.orderId" />
            <henpay-text-up
              :placeholder="'商户订单号'"
              v-model:value="vdata.searchData.mchOrderNo"
            />
            <henpay-text-up :placeholder="'商户号'" v-model:value="vdata.searchData.mchNo" />
            <henpay-text-up :placeholder="'服务商号'" v-model:value="vdata.searchData.isvNo" />
...
const tableColumns = [
  { key: 'orderId', title: '订单ID', fixed: 'left', dataIndex: 'orderId',width: 200 },
  { key: 'mchOrderNo', title: '商户订单号', dataIndex: 'mchOrderNo',width: 200 },
