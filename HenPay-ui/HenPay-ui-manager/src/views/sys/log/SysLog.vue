...
<!--              <a-icon slot="suffixIcon" type="sync" />-->
            ...
            <henpay-text-up :placeholder="'用户ID'" v-model:value="vdata.searchData.userId" />
            <henpay-text-up :placeholder="'用户名'" v-model:value="vdata.searchData.userName" />
            <a-select
...
const tableColumns = reactive([
  ...
  { key: 'userId', title: '用户ID', dataIndex: 'userId',width: 100 },
  { key: 'userIp', title: '用户IP', dataIndex: 'userIp',width: 100 },
  { key: 'sysType', title: '所属系统', scopedSlots: { customRender: 'sysTypeSlot' }, width: 100 },
  { key: 'methodRemark', title: '操作描述', ellipsis: true, dataIndex: 'methodRemark', width: 100 },
