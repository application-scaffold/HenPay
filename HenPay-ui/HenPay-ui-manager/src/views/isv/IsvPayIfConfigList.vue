...
<!--              <a-icon key="right" type="right" style="font-size: 13px"></a-icon>-->
              <right-outlined :style="{ fontSize: '13px' }" />
            </a>
            <a v-else>暂无操作</a>
          </div>
        </div>
...
<!--                    <a-icon :type="vdata.loading ? 'loading' : 'upload'" />-->
                    <component :is="vdata.loading ? LoadingOutlined : UploadOutlined" />
...
import HenpayCard from '@/components/HenpayCard/HenpayCard.vue'
import HenpayUpload from '@/components/HenpayUpload/HenpayUpload.vue'
