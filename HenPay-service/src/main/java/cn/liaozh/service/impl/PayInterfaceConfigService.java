...
import cn.liaozh.core.entity.*;
import cn.liaozh.core.exception.BizException;
import cn.liaozh.service.mapper.PayInterfaceConfigMapper;
    ...
    */
    ...
    public List<PayInterfaceDefine> selectAllPayIfConfigListByAppId(String appId) {
        ...
        if (mchApp == null|| mchApp.getState() != CS.YES) {
            throw new BizException(String.valueOf(ApiCodeEnum.SYS_OPERATION_FAIL_SELETE));
        }
